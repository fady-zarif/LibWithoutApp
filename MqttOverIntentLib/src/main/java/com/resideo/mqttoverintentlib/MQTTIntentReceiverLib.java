...
/**
 * this class should be used by whoever wants to publish, subscribe, unsubscribe or receive mqtt requests
 * */
public class MQTTIntentReceiverLib implements IMQTTIntentReceiver {
    private IMQTTReceiver mReceiver;
    private Context mContext;
    private String mAction;

    public MQTTIntentReceiverLib(Context context, String action, IMQTTReceiver callBack) {
        mContext = context;
        mAction = action;
        mReceiver = callBack;
