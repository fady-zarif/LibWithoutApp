...
/**
 * this class used to register receiver that will receive mqtt requests from external apps
 * and notify the implementer with these requests
 */
public class MQTTExternalRequest {
    ...
    private void initReceiver(Context context) {
        ...
        context.registerReceiver(externalRequestReceiver, intentFilter);
    }

    private BroadcastReceiver externalRequestReceiver = new BroadcastReceiver() {
        @Override
    ...
    public void publishToExternalOwners(String topic, String message, String owner) {
        ...
        Log.e(TAG_MQTT, "PublishToExternalOwners Invoked " + topic + message);
    }
}
